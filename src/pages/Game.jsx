        ...
        <>
          ...
          <div className="action">
            ...
            <div className="right">
              ...
              <div
                className={`${selectedCoin === 1000 ? "coin active" : "coin"} ${coin < 1000 && "disable"
                  } `}
              ...
              <div
                className={`${selectedCoin === 50000 ? "coin active" : "coin"
                  } ${coin < 50000 && "disable"}`}
              ...
              <div
                className={`${selectedCoin === 100000 ? "coin active" : "coin"} ${coin < 100000 && "disable"
                  }`}
